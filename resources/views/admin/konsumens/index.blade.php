                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning btn-xs edit-btn"
                                    ...
                                    data-is_active="{{ $konsumen->is_active }}"
                                    data-toggle="modal"
                                    data-target="#editModal">
                                Edit
                            </button>
                            <form action="{{ route('admin.konsumens.destroy', $konsumen->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin?');">
                                @csrf
                                @method('DELETE')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="kode_konsumen" placeholder="Contoh: CUST001" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nama Konsumen</label>
                                    <input type="text" class="form-control" name="nama_konsumen" placeholder="Contoh: BENGKEL MAJU JAYA" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="modal-body">
                         <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Kode Konsumen</label>
                                    <input type="text" class="form-control" id="edit_kode_konsumen" name="kode_konsumen" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
