...
class UserSeeder extends Seeder
{
    public function run()
    {
        ...
        // Ambil semua jabatan dan gudang
        ...
        User::create([
            ...
            'jabatan_id' => $jabatans['SA'], 'password' => Hash::make('password'),
        ]);

        // Buat Manajer Area
        User::create([
            'nik' => 'MA-PST-001', 'username' => 'manajer_ma', 'nama' => 'Manajer Area',
            'jabatan_id' => $jabatans['MA'], 'password' => Hash::make('password'),
        ]);

        // Buat pengguna untuk setiap gudang
